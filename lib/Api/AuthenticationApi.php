...
class AuthenticationApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Credentials $body Create new JWT Token (optional)
     *
    ...
    protected function postCredentialsItemRequest($body = null)
    {
        ...
        $resourcePath = '/api/v1/authentication_token';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Swagger\Client\Model\Token
     */
    public function putCredentialsItem($body = null)
    {
        list($response) = $this->putCredentialsItemWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation putCredentialsItemWithHttpInfo
     *
     * Refresh JWT token.
     *
     * @param  \Swagger\Client\Model\Credentials $body Create new JWT Token (optional)
     ...
     * @return array of \Swagger\Client\Model\Token, HTTP status code, HTTP response headers (array of strings)
     */
    public function putCredentialsItemWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\Token';
        $request = $this->putCredentialsItemRequest($body);
    ...
    /**
     * Operation putCredentialsItemAsync
     *
     * Refresh JWT token.
     *
     * @param  \Swagger\Client\Model\Credentials $body Create new JWT Token (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putCredentialsItemAsync($body = null)
    {
        return $this->putCredentialsItemAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putCredentialsItemAsyncWithHttpInfo
     *
     * Refresh JWT token.
     *
     * @param  \Swagger\Client\Model\Credentials $body Create new JWT Token (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putCredentialsItemAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Swagger\Client\Model\Token';
        $request = $this->putCredentialsItemRequest($body);
    ...
    /**
     * Create request for operation 'putCredentialsItem'
     *
     * @param  \Swagger\Client\Model\Credentials $body Create new JWT Token (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putCredentialsItemRequest($body = null)
    {
